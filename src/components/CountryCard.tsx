...
import { addCountryToBuz } from '../redux/actions/FeedbackAction';
...
export default function CountryCard({ flag, name, region, population, capital, currency, onClick }: CountryCardProps) {
    ...
    const handleVisited = (name: any) => {
        dispatch(addCountryToBuz(name))
    }
        ...
        <Card className={classes.root}>
            ...
            <CardActions style={{marginBottom: 10, justifyContent: 'space-between', float: 'right' }} key={name}>
               <div className='flex '>
                ...
                <div className="cursor-pointer bg-green p-1 " onClick={() => handleVisited(name)}>
