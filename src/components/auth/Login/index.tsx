            ...
            <div className="flex flex-col items-center justify-center" style={{ height: '100vh' }}>
                ...
                <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <button aria-label="Continue with github" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p className="text-base font-medium ml-4 text-gray-700">Login with Github</p>
                    </button>
                    <button aria-label="Continue with twitter" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p className="text-base font-medium ml-4 text-gray-700">Login with Twitter</p>
                    </button>
                    ...
                    <div className="mt-6  w-full">
                        ...
                        <div className="relative flex items-center justify-center">
                            <input aria-label="enter Password" role="input" type="password" name="password" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
